...
if __name__ == "__main__":
    ...
    #%% Prepare the model
    resnet_nn = resnet50(pretrained=False, progress=True, num_classes=10, context_size=context_size, qk_size=qk_size,
                         heads=heads)
    ...
    log_dir = os.path.join('../runs', 'lambda', current_time + '_' + socket.gethostname())
    ...
    max_epoch = 0
    if resume:
        folder_checkpoint = '.\Checkpoints\\Lambda'
